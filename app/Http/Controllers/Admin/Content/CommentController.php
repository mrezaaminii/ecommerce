...
class CommentController extends Controller
{
    ...
    {
        $unSeenComments = Comment::where('seen',0)->where('commentable_type','App\Models\Admin\Content\Post')->get();
        foreach ($unSeenComments as $unSeenComment){
            $unSeenComment->seen = 1;
            $result = $unSeenComment->save();
        }
        $comments = Comment::orderBy('created_at','desc')->where('commentable_type','App\Models\Admin\Content\Post')->simplePaginate(15);
