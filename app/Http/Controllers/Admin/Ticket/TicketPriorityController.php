...
class TicketPriorityController extends Controller
{
    ...
    public function store(TicketPriorityRequest $request)
    {
        ...
        return redirect()->route('admin.ticket.priority.index')->with('swal-success','اولویت تیکت با موفقیت ثبت شد');
    }
    ...
    public function update(TicketPriorityRequest $request,TicketPriority $ticketPriority)
    {
        ...
        return redirect()->route('admin.ticket.priority.index')->with('swal-success','اولویت تیکت با موفقیت ویرایش شد');
    }
