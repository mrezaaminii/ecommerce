...
class TicketCategoryController extends Controller
{
    ...
    public function store(TicketCategoryRequest $request)
    {
        ...
        return redirect()->route('admin.ticket.category.index')->with('swal-success','دسته بندی تیکت با موفقیت ثبت شد');
    }
    ...
    public function update(TicketCategoryRequest $request,TicketCategory $ticketCategory)
    {
        ...
        return redirect()->route('admin.ticket.category.index')->with('swal-success','دسته بندی تیکت با موفقیت ویرایش شد');
    }
