                                    ...
                                    @foreach($user->addresses as $address)
                                        ...
                                        <label for="a1-{{$loop->iteration}}" class="address-wrapper mb-2 p-2">
                                            <section class="mb-2">
                                                ...
                                                , {{$address->address ?? '-'}}, پلاک {{$address->no ?? '-'}},
                                                واحد {{$address->unit ?? '-'}}
                                            </section>
                                            <section class="mb-2">
                                        ...
                                        <section class="modal fade" id="edit-address-{{$address->id}}" tabindex="-1"
                                                 aria-labelledby="edit-address-label" aria-hidden="true">
                                                        ...
                                                        <form class="row" method="post"
                                                            ...
                                                            <section class="col-12 mb-2">
                                                                ...
                                                                <textarea name="address"
                                                                          ...
                                                                          id="address" placeholder="نشانی">{{$address->address}}</textarea>
                                                            </section>

                                                            <section class="col-6 mb-2">
                                                                <label for="postal_code" class="form-label mb-1">کد
                                                                    پستی</label>
                                                                <input value="{{$address->postal_code}}" name="postal_code" type="text"
                                                                       class="form-control form-control-sm"
                                                            ...
                                                            <section class="col-3 mb-2">
                                                                ...
                                                                <input value="{{$address->no}}" name="no" type="text"
                                                                       class="form-control form-control-sm"
                                                            ...
                                                            <section class="col-3 mb-2">
                                                                ...
                                                                <input value="{{$address->unit}}" name="unit" type="text"
                                                                       class="form-control form-control-sm"
                                                            ...
                                                            <section class="col-12 mb-2">
                                                                <section class="form-check">
                                                                    <input {{$address->recipient_first_name ? 'checked' : ''}} name="receiver" class="form-check-input"
                                                                           type="checkbox"
                                                                           id="receiver">
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                <label for="first_name" class="form-label mb-1">نام
                                                                    گیرنده</label>
                                                                <input value="{{$address->recipient_first_name ?? '-'}}" name="recipient_first_name" type="text"
                                                                       class="form-control form-control-sm"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <input value="{{$address->recipient_last_name ?? '-'}}" name="recipient_last_name" type="text"
                                                                       class="form-control form-control-sm"
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                <label for="mobile" class="form-label mb-1">شماره
                                                                    موبایل</label>
                                                                <input value="{{$address->mobile ?? '-'}}" name="mobile" type="text"
                                                                       class="form-control form-control-sm"
                            ...
                            <section class="content-wrapper bg-white p-3 rounded-2 cart-total-price">
                                ...
                                <section class="d-flex justify-content-between align-items-center">
                                    ...
                                    <p class="text-muted"><span
                                            id="total_product_price">{{ helper::priceFormat($totalProductPrice) }}</span>
                                        تومان</p>
                                </section>
                                ...
                                @if($totalDiscount != 0)
                                    <section class="d-flex justify-content-between align-items-center">
                                        ...
                                        <p class="text-danger fw-bolder"><span
                                                id="total_discount">{{ helper::priceFormat($totalDiscount) }}</span>
                                            تومان</p>
                                    </section>
                                @endif
