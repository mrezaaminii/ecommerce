                                    ...
                                    @foreach($user->addresses as $address)
                                        ...
                                        <label for="a1" class="address-wrapper mb-2 p-2">
                                            <section class="mb-2">
                                                ...
                                                آدرس : استان {{$address->city->province->name ?? '-'}} , {{$address->address ?? '-'}}, پلاک {{$address->no ?? '-'}}, واحد {{$address->unit ?? '-'}}
                                            </section>
                                            <section class="mb-2">
                                                        ...
                                                        <form class="row" method="post" action="{{route('customer.sales-process.add-address')}}">
                                                            ...
                                                            <section class="col-6 mb-2">
                                                                ...
                                                                <select name="province_id" class="form-select form-select-sm"
                                                                    ...
                                                                    <option data-url="{{route('customer.sales-process.get-cities',$province)}}" value="{{$province->id}}">{{$province->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </section>
                                                            <section class="col-6 mb-2">
