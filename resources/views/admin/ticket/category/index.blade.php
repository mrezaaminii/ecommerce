        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{route('admin.ticket.category.create')}}" class="btn btn-info">ایجاد دسته بندی</a>
                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="">
                                    <input id="{{$ticketCategory->id}}" type="checkbox" onchange="changeStatus({{$ticketCategory->id}})" data-url="{{route('admin.ticket.category.status',$ticketCategory->id)}}" @if($ticketCategory->status == 1) checked @endif>
                                </label>
                            </td>
