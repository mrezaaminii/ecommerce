        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{route('admin.market.guarantee.create',$product->id)}}" class="btn btn-info">ایجاد گارانتی جدید</a>
                        ...
                        @foreach($product->guarantees as $guarantee)
                            <tr>
                                ...
                                <td class="text-left width-8-rem">
                                    <form class="d-inline" action="{{route('admin.market.guarantee.destroy',['product' => $product->id,'guarantee' => $guarantee->id])}}" method="POST" id="deleteForm">
                                        @csrf
                                        @method('delete')
