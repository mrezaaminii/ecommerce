        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{route('admin.market.color.create',$product->id)}}" class="btn btn-info">ایجاد رنگ جدید</a>
                        ...
                        @foreach($product->colors as $color)
                            <tr>
                                ...
                                <td class="text-left width-8-rem">
                                    <form class="d-inline" action="{{route('admin.market.color.destroy',['product' => $product->id,'productColor' => $color->id])}}" method="POST" id="deleteForm">
                                        @csrf
                                        @method('delete')
