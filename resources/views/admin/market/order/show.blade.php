            ...
            <section class="main-body-container">
                ...
                <section class="table-responsive">
                    <table class="table table-striped table-hover h-150px" id="printable">
                        ...
                        <tr class="border-bottom">
                            <th>وضعیت ارسال</th>
                            <td class="text-left font-weight-bolder">{{helper::jalaliDate($order->delivery_date)}}</td>
                        </tr>
                        <tr class="border-bottom">
                        ...
                        <tr class="border-bottom">
                            ...
                            <td class="text-left font-weight-bolder">{{$order->order_copan_discount_amount ?? '-'}} </td>
                        </tr>
                        <tr class="border-bottom">
