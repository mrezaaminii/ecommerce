...
@section('content')
        <section class="row">
            <section class="col-lg-3 col-md-6 col-12 mb-4">
                <a href="#" class="text-decoration-none d-block">
                    <section class="card bg-custom-yellow text-white">
                        ...
                        <section class="card-footer info-box-footer">
                            <i class="fa fa-clock mx-2"></i>به روز رسانی شده در تاریخ : 21:42 بعد از ظهر
                        </section>
                    </section>
                </a>
            </section>
            ...
            <section class="col-12">
                <section class="main-body-container">
                    <section class="main-body-container-header">
                        <h5>بخش کاربران</h5>
                        <p>در این بخش اطلاعات مربوط به کاربران به شما داده میشود</p>
                    </section>
