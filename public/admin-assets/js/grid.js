...
$('#sidebar-toggle-hide').click(function (){
    ...
    $('#search-toggle').click(function (){
        ...
        $('#search-input').animate({width: "12rem"},800)
        },50)
    })
    ...
    $('.sidebar-group-link').click(function (){
        ...
        if ($(this).hasClass('sidebar-group-link-active')) {
            ...
            $(this).children('.sidebar-dropdown-toggle').children('.angle').removeClass('fa-angle-down').addClass('fa-angle-left');
            return;
        }

        $('.sidebar-group-link').removeClass('sidebar-group-link-active')
        $('.sidebar-group-link').children('.sidebar-dropdown-toggle').children('.angle').removeClass('fa-angle-down').addClass('fa-angle-left');

        $(this).addClass('sidebar-group-link-active')
        $(this).children('.sidebar-dropdown-toggle').children('.angle').removeClass('fa-angle-left').addClass('fa-angle-down');
